...
export function registerListWidgets() {
  registerDashboardWidget({
    ...
    resolve: (report) => ({
      ...
      kind: "entity_list",
      tone: report.projections.criticalWork.length ? "danger" : "success",
      title: "Critical Work",
      description: "Open critical severity work items",
      module: "work",
      emptyMessage: "No critical work open.",
      items: toCardItems(report.projections.criticalWork),
    }),
  });
