...
const lens = getExecutiveLens("performance");

export const metadata: Metadata = { title: `${lens.label} · Executive Office` };

/** Executive Office → performance lens (the same Executive Office projection and gate as the Overview; never moves the last-visit marker). */
export default async function ExecutivePerformanceRoute() {
