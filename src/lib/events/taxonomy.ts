...
export const OperationalEventTypes = {
  ...
  FACILITY_REQUEST_DEACTIVATED: "facility.request_deactivated",
  FACILITY_REQUEST_REVIEW_STARTED: "facility.request_review_started",
  FACILITY_REQUEST_MAINTENANCE_CREATED: "facility.request_maintenance_created",
  FACILITY_REQUEST_INCIDENT_CREATED: "facility.request_incident_created",
  FACILITY_REQUEST_MAINTENANCE_LINKED: "facility.request_maintenance_linked",
  FACILITY_REQUEST_INCIDENT_LINKED: "facility.request_incident_linked",
  FACILITY_REQUEST_RESOLVED: "facility.request_resolved",
  FACILITY_REQUEST_CANCELLED: "facility.request_cancelled",
...
export const OPERATIONAL_EVENT_CATALOG: OperationalEventTypeDefinition[] = [
  ...
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_CREATED,
    domain: "facility",
    description: "An intake request was created.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_UPDATED,
    domain: "facility",
    description: "An intake request was updated.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_STATUS_CHANGED,
    domain: "facility",
    description: "An intake request status changed.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_DEACTIVATED,
    domain: "facility",
    description: "An intake request was deactivated.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_REVIEW_STARTED,
    domain: "facility",
    description: "Facility review started on an intake request.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_MAINTENANCE_CREATED,
    domain: "facility",
    description: "A maintenance treatment was created from a request.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_INCIDENT_CREATED,
    domain: "facility",
    description: "An incident treatment was created from a request.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_MAINTENANCE_LINKED,
    domain: "facility",
    description: "An existing maintenance record was linked to a request.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_INCIDENT_LINKED,
    domain: "facility",
    description: "An existing incident record was linked to a request.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_RESOLVED,
    domain: "facility",
    description: "An intake request was resolved.",
    defaultEntityType: "request",
  },
  {
    eventType: OperationalEventTypes.FACILITY_REQUEST_CANCELLED,
    domain: "facility",
    description: "An intake request was cancelled.",
    defaultEntityType: "request",
  },
  {
