...
export const EXECUTIVE_OFFICE_LENSES: readonly ExecutiveLens[] = [
  {
    ...
    icon: Gavel,
    match: "prefix",
    purpose: "What is awaiting an executive decision.",
  ...
  },
  {
    ...
    icon: Landmark,
    match: "prefix",
    purpose: "Where financial exposure and position stand.",
    foundation: "The organisation's financial position will appear here as Executive Office capabilities are introduced.",
    overviewSection: { anchor: "scc-pulse-heading", label: "Organisational Pulse — Finance" },
  },
  {
    id: "commitments",
