...
export function mapFmWorkRowToMaintenance(row: FmWorkRow): Maintenance {
  ...
  return {
    ...
    workOrderIds: [],
    sourceRequestId: row.source_request_ref ?? undefined,
